...
import com.iamtheonewhoknocks.toolkit.R;
...
public class StopwatchService extends Service {
	...
	public void updateNotification() {
		...
		m_notification.setLatestEventInfo(context, contentTitle, contentText,
				contentIntent);
	 ...
	 * @return String with the current time in the format MM:SS.T or HH:MM:SS.T,
