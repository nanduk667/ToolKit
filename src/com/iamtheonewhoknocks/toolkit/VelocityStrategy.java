...
public class VelocityStrategy implements Strategy {
	public double Convert(String from, String to, double input) {
		...
		if ((from.equals(ConverterActivity.getInstance()
				...
				.getString(R.string.velocityunitmilesperh)) && to
				.equals(ConverterActivity.getInstance().getApplicationContext()
						.getResources().getString(R.string.velocityunitkmph)))) {
		...
		if ((from.equals(ConverterActivity.getInstance()
				.getApplicationContext().getResources()
				.getString(R.string.velocityunitkmph)) && to
				.equals(ConverterActivity.getInstance().getApplicationContext()
						.getResources()
						.getString(R.string.velocityunitmilesperh)))) {
		...
		if ((from.equals(ConverterActivity.getInstance()
				...
				.equals(ConverterActivity.getInstance().getApplicationContext()
						.getResources()
						.getString(R.string.velocityunitmeterpers)))) {
		...
		if ((from.equals(ConverterActivity.getInstance()
				.getApplicationContext().getResources()
				.getString(R.string.velocityunitmeterpers)) && to
				.equals(ConverterActivity.getInstance().getApplicationContext()
						.getResources()
						.getString(R.string.velocityunitmilesperh)))) {
		...
		if ((from.equals(ConverterActivity.getInstance()
				...
				.equals(ConverterActivity.getInstance().getApplicationContext()
						.getResources()
						.getString(R.string.velocityunitfeetpers)))) {
		...
		if ((from.equals(ConverterActivity.getInstance()
				.getApplicationContext().getResources()
				.getString(R.string.velocityunitfeetpers)) && to
				.equals(ConverterActivity.getInstance().getApplicationContext()
						.getResources()
						.getString(R.string.velocityunitmilesperh)))) {
